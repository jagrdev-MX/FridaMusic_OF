...
package com.jagr.fridamusic.listentogether
...
import com.jagr.fridamusic.constants.ListenTogetherAutoApprovalKey
import com.jagr.fridamusic.constants.ListenTogetherIsHostKey
import com.jagr.fridamusic.constants.ListenTogetherRoomCodeKey
import com.jagr.fridamusic.constants.ListenTogetherServerUrlKey
import com.jagr.fridamusic.constants.ListenTogetherSessionTimestampKey
import com.jagr.fridamusic.constants.ListenTogetherSessionTokenKey
import com.jagr.fridamusic.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.jagr.fridamusic.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.jagr.fridamusic.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.jagr.fridamusic.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.jagr.fridamusic.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.jagr.fridamusic.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.jagr.fridamusic.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
